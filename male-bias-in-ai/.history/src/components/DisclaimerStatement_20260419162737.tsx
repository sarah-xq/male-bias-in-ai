  ...
  return (
    <>
      ...
      <p>
        ...
        not-so-artificial intelligence in my head. The only thing I used AI for
        was to generate the styling used for this webpage, as most developers
        such as myself suck at styling webpage layouts. This is a common use of
        AI within my field.
        <br />
        <b>
