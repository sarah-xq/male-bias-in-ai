...
import chat from "../assets/chatgpthuman.png";
import gemini from "../assets/geminihuman.png";
import copilot from "../assets/copilothuman.png";
import dalle from "../assets/dallehuman.png";
