...
import chat from "../../public/chatgpthuman.png";
import gemini from "../../public/geminihuman.png";
import copilot from "../../public/copilothuman.png";
import dalle from "../../public/dallehuman.png";
  ...
  return (
    <>
      ...
      <p className="smaller">
        ...
        with manual filtering, so this issue is not something to blame
        exclusively on the introduction of AI filtering, but rather a
        perpetuation of the same issue. I think if we can address the gender
        inequality problem now by training AI to avoid these biases, the
        introduction of algorithmic filtering could actually show positive
        results for female hiring rates.
      </p>
    </>
  );
}
